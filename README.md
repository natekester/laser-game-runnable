...
This is the standalone runnable version of the Laser Click application written in golang with opencv and react - enabling friends to play the games associated. It allows you to control your computer mouse using a physical laser pointer and a webcam. 
